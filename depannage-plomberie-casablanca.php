        ...
        <div class="row">
          <div class="col-xl-12  col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
            ...
            <div class="elementor-text-editor elementor-clearfix">
              ...
              <p>Le dépannage de plomberie est une nécessité fréquente chez les résidents de Casablanca, que ce soit pour des fuites d'eau, des canalisations bouchées ou des problèmes de robinetterie. Les problèmes de plomberie peuvent survenir à tout moment et causer des dommages importants à votre maison si vous ne les traitez pas rapidement. 
              </p>
              <p>La première étape pour le dépannage de plomberie à Casablanca est d'identifier le problème. Si vous avez une fuite d'eau, localisez la source de la fuite et fermez l'arrivée d'eau. Si vous avez une canalisation bouchée, essayez d'identifier l'endroit où se trouve le bouchon. Si vous avez un problème de robinetterie, identifiez le type de robinet et le problème spécifique.</p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-xl-6  col-lg-6 col-md-12 col-sm-12 col-xs-12 text-center">
            <img id="imgser" alt="societe professionel dans le depannage plomberie a casablanca"
              src="img/img plomberie webp/depannage-plomberie-casablanca.webp">
          </div>
          <div class="col-xl-6  col-lg-6 col-md-12 col-sm-12 col-xs-12 text-center">
            <div class="col-xl-12  col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
              <div class="elementor-text-editor elementor-clearfix">
          ...
          <div class="row">
            ...
            <div class="col-xl-6  col-lg-6 col-md-12 col-sm-12 col-xs-12 text-center">
              <img id="imgser" alt="societe professionel dans le depannage plomberie au maroc"
                src="img/img plomberie webp/depannage-plomberie.webp">
            </div>
          </div>
