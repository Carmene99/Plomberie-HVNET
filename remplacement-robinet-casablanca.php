        ...
        <div class="row">
          <div class="col-xl-12  col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
            ...
            <div class="elementor-text-editor elementor-clearfix">
              ...
              <p>Les robinets sont des éléments essentiels dans toutes les maisons et bâtiments de Casablanca, car ils permettent de contrôler l'arrivée d'eau. Cependant, avec le temps, les robinets peuvent devenir défectueux ou cassés, ce qui peut entraîner des fuites d'eau et des pertes de pression. Si votre robinet est endommagé, il est important de le remplacer rapidement pour éviter tout dommage supplémentaire. 
              </p>
              <p>Avant de remplacer un robinet à Casablanca, la première étape consiste à éteindre l'arrivée d'eau. Cela permet d'éviter les fuites et les dégâts d'eau. Cherchez la vanne d'arrêt qui se trouve près du robinet à remplacer, fermez-la et ouvrez le robinet pour libérer toute l'eau restante.</p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-xl-6  col-lg-6 col-md-12 col-sm-12 col-xs-12 text-center">
            <img id="imgser" alt="societe professionel dans le remplacement robinet a casablanca"
              src="img/img plomberie webp/Remplacement-robinet-casablanca.webp">
          </div>
          <div class="col-xl-6  col-lg-6 col-md-12 col-sm-12 col-xs-12 text-center">
            <div class="col-xl-12  col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
              <div class="elementor-text-editor elementor-clearfix">
          ...
          <div class="row">
            ...
            <div class="col-xl-6  col-lg-6 col-md-12 col-sm-12 col-xs-12 text-center">
              <img id="imgser" alt="societe professionel dans le remplacement robinet au maroc"
                src="img/img plomberie webp/reparation-robinet-plombier-casablanca.webp">
            </div>
          </div>
