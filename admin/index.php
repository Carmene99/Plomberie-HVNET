<?php
  ...
  $stmt = $conn->prepare("SELECT * from infos Limit 2");
  $stmt->execute();
  $infos = $stmt->fetch();
  ...
  if(isset($_POST["update"])){
        ...
        $stmt = $conn->prepare("UPDATE infos SET Tel=?, email=?, adresse=?, presentation=?, temps_travail=?, facebook=?, twitter=?, linkedin=? WHERE id=2");
...
<li class="nav-item active">
    <a class="nav-link" href="index.php">
        ...
        <span>Tableau de bord</span></a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="pages/reparation_fuite_d'eau/index.php">
                <i style="font-size:16px;" class="bi bi-file-earmark"></i>
                    <span>Reparation-fuite-d'eau</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="pages/debouchage_wc/index.php">
                <i style="font-size:16px;" class="bi bi-file-earmark"></i>
