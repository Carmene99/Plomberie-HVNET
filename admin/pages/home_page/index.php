                ...
                <div class="container-fluid">
                      ...
                      <form enctype="multipart/form-data" class="pt-2" method="post">
                        <!-- slider -->
                            <div class="w-100 m-2">
                                <div>
                                  <label class="form-label">Retrouver toutes les images de la barre de défilement (Slider) ici !</label>
                                    ...
                                    <div class="d-flex mt-2 gap-3 flex-wrap justify-content-between">
                                        <?php
                                           foreach ($home_slider_imgs as $img) {
                                            ?>
                                                <div class="shadow shadow-lg" style="width:280px; border-radius:15px; height: 320px;">
                                                    <img style="height:90%; border-top-right-radius:10px; border-top-left-radius:10px; width:100%;" src="./slider_imgs/<?php echo $img["img"]; ?>" />
                        ...
                        <div class="w-100 m-2">
                                <div>
                                  <label class="form-label">Retrouver toutes les images des partenaires ici !</label>
                        ...
                        <form enctype="multipart/form-data" class="pt-2" method="post">
                            ...
                            <div class="w-100 m-2">
                                <div>
                                  <label class="form-label">Retrouver toutes l'image du banner ici !</label>
                                  <div class="d-flex gap-2">
