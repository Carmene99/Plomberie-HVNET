<?php
 ...
 if(!isset($_SESSION["login"])){
  ...
  $stmt = $conn->prepare("SELECT * from reparation_eau LIMIT 1");
  $stmt->execute();
  $fetch = $stmt->fetch();
 ...
 /* update the imgs */
  if(isset($_POST["update_imgs"])){
    if($_FILES["img1"]["name"]=="" && $_FILES["img2"]["name"]==""){
        ...
        $stmt = $conn->prepare("UPDATE reparation_eau SET img1=:img1");
        ...
        $stmt = $conn->prepare("UPDATE reparation_eau SET img2=:img2");
        ...
        unlink("imgs/".$fetch["img1"]);
        unlink("imgs/".$fetch["img2"]);
        $stmt = $conn->prepare("UPDATE reparation_eau SET img1=:img1,img2=:img2");
        $img1 = $_FILES["img1"]["name"];
        $img2 = $_FILES["img2"]["name"];
        $stmt->bindParam(":img1",$img1);
        $stmt->bindParam(":img2",$img2);
...
//   update the presentation
  if(isset($_POST["update_presentation"])){
         ...
         $stmt = $conn->prepare("UPDATE reparation_eau SET presentation=:presentation");
...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
    ...
    <div class="sidebar-brand-text mx-3">Carmène <sup></sup></div>
</a>
...
<li class="nav-item active">
    <a class="nav-link" href="index.php">
        ...
        <span>Tableau de bord</span></a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="../reparation_fuite_d'eau/index.php">
                <i style="font-size:16px;" class="bi bi-file-earmark"></i>
                    <span>Reparation-fuite-d'eau</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="../debouchage_wc/index.php">
                <i style="font-size:16px;" class="bi bi-file-earmark"></i>
                    <span>Debouchage-wc</span></a>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <h3 class="m-2">HVNET PLOMBERIE</h3>
                ...
                <div class="container-fluid">
                      <div class="d-flex justify-content-between">
                            <h1 class="m-2">REPARATION FUITE D'EAU</h1>
                      </div>
                      <?php
                                if($success != "") {
                      ...
                      <!-- le code <form enctype="multipart/form-data" method="post"> indique que le formulaire qui suit va contenir des champs de type fichier (ou des données binaires) et que ces données seront envoyées au serveur via une requête HTTP POST -->
